...
| --- | --- | --- | --- | --- | --- |
| Claude | ESP-009.D — differential coverage of text and the resource ceilings (subtask of ESP-009) | `claude/differential-text` | DONE | `crates/argorix_core_c/**`, `conformance/core_c/**`, `.github/workflows/core-c.yml`, `tasks/espada/ESP-009.D.md` | [coordination/claude.md](coordination/claude.md) |
