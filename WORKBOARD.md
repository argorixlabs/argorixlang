...
| --- | --- | --- | --- | --- | --- |
| Claude | ESP-018 — the agent and policy language, migrated (subtasks A–E; A: the lexer) | `claude/agent-lexer-esp018`, `claude/agent-parser-esp018b` | IN PROGRESS (A in #64, B done, C: checks done, modules next) | `compiler/agent_lexer.argx`, `compiler/unicode.argx`, `compiler/agent_parser.argx`, `compiler/agent_ast.argx`, `compiler/agent_schema.argx`, `compiler/agent_words.argx`, `compiler/agent_check.argx`, `spec/language/ast.md`, `spec/language/check.md`, `crates/argorix_semantics/src/agent_check_dump.rs`, `tests/selfhost/agent/**`, `spec/language/tokens.md`, `tasks/espada/ESP-018.md`, the token dump of `crates/argorix_parser/src/lexer.rs`, `crates/argorixc/tests/agent_lexer_differential.rs`, `crates/argorixc/tests/unicode_tables.rs` | [coordination/claude.md](coordination/claude.md) |
