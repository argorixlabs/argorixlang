...
| --- | --- | --- | --- | --- | --- |
| Claude | ESP-013 — lowering and emission in Argorix (subtasks A–D) | `claude/trabajo-pendiente-ae9bcz` | IN PROGRESS (A and C done, stacked on ESP-012.C in #57) | `compiler/ir.argx`, `compiler/c_emit.argx`, `tests/selfhost/ir/**`, `tests/selfhost/c/**`, `spec/core/ir.md`, `tasks/espada/ESP-013.md`, the stage0 IR where the port needs it | [coordination/claude.md](coordination/claude.md) |
