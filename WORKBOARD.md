...
| Claude | MAT-029 — governance, support, and maintenance | `claude/governance-mat029` | DONE | `GOVERNANCE.md`, `SECURITY.md`, `CONTRIBUTING.md`, `operations/**`, `tasks/madurez/MAT-029.md`, `spec/MAT-029-validation.json`, `CODE_OF_CONDUCT.md`, `.github/CODEOWNERS`, `.github/PULL_REQUEST_TEMPLATE.md` | [coordination/claude.md](coordination/claude.md) |
