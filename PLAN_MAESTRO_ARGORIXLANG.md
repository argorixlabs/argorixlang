...
Fecha: 2026-09-18. Estado: EN EJECUCIÓN; ESP-001–006 y MAT-001–007 cerradas como inventario, baseline, arquitectura, especificación/prototipo Core, frontend stage0 y contratos/modelos; lowering y ejecución Core aún no están implementados.
...
- ESP-001–006 y MAT-001–007 están HECHAS como inventario, baseline, arquitectura, especificación/prototipo Core, frontend stage0, contratos y modelos reducidos; las otras 42 tareas están PENDIENTES. El frontend solo analiza Core: no baja a IR, no ejecuta y no demuestra independencia de Rust. Ninguno de los 29 requisitos funcionales se ha aceptado por estos cierres. El registro incluye `esp_progress` para cierres ESP. No hay release nueva ni auditoría de seguridad completada.
