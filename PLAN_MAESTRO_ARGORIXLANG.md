...
Fecha: 2026-09-19. Estado: EN EJECUCIÓN; ESP-001–007 y MAT-001–007 cerradas como inventario, baseline, arquitectura, especificación/prototipo Core, frontend stage0, IR verificado y contratos/modelos; ejecución Core aún no está implementada.
...
- Primeros cierres: [ESP-001](tasks/espada/ESP-001.md) como inventario, [ESP-002](tasks/espada/ESP-002.md) como [baseline histórico](bootstrap/baseline.json), [ESP-003](tasks/espada/ESP-003.md) como [arquitectura de independencia](bootstrap/architecture.md), [ESP-004](tasks/espada/ESP-004.md) como [especificación Core](spec/core/README.md), [ESP-005](tasks/espada/ESP-005.md) como [memoria](spec/core/memory.md)/[ABI host](spec/host-abi.md), [ESP-006](tasks/espada/ESP-006.md) como frontend Core Rust stage0, [ESP-007](tasks/espada/ESP-007.md) como IR Core verificado, [MAT-001](tasks/madurez/MAT-001.md) como [contrato de producto](spec/product-contract.md), [MAT-002](tasks/madurez/MAT-002.md) como [arquitectura de confianza](spec/trust-boundaries.md), [MAT-003](tasks/madurez/MAT-003.md) como [contrato normativo](spec/language/current-v1.md), [MAT-004](tasks/madurez/MAT-004.md) como [memoria abstracta](spec/memory-model.md)/[efectos](spec/effect-system.md), [MAT-005](tasks/madurez/MAT-005.md) como [concurrencia](spec/concurrency.md)/[entrega](spec/message-delivery.md), [MAT-006](tasks/madurez/MAT-006.md) como [capacidades A1](spec/capabilities.md) y [MAT-007](tasks/madurez/MAT-007.md) como identidad, secretos y procedencia. Las otras 41 tareas siguen pendientes.
...
Cada enlace abre una ficha ejecutable completa. MAT-001 a MAT-007 están HECHAS como contratos/modelos de definición; las otras MAT siguen PENDIENTES. El progreso se basa en aceptación demostrada, no en número de archivos generados.
...
| [MAT-029](tasks/madurez/MAT-029.md) | Gobernanza, soporte y mantenimiento del lenguaje | P0 | MAT-001, ESP-001 | PENDIENTE |
...
- ESP-001–007 y MAT-001–007 están HECHAS como inventario, baseline, arquitectura, especificación/prototipo Core, frontend stage0, IR verificado, contratos y modelos reducidos; las otras 41 tareas están PENDIENTES. Core baja a IR verificado, pero no se ejecuta y no demuestra independencia de Rust. Ninguno de los 29 requisitos funcionales se ha aceptado por estos cierres. El registro incluye `esp_progress` para cierres ESP. No hay release nueva ni auditoría de seguridad completada.

Contexto verificado: `SECURITY.md` aún describe el proyecto como pre-1.0 mientras el workspace declara 1.0.0. MAT-029 debe alinear la política con el estado de versiones realmente publicado; no inferir una release pública del número de Cargo.
