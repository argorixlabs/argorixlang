...
Fecha: 2026-09-19. Estado: EN EJECUCIÓN; ESP-001–007, MAT-001–007 y MAT-029 cerradas como inventario, baseline, arquitectura, especificación/prototipo Core, frontend stage0, IR verificado, contratos/modelos y gobernanza; ejecución Core aún no está implementada.
...
- ESP-001–007, MAT-001–007 y MAT-029 están HECHAS como inventario, baseline, arquitectura, especificación/prototipo Core, frontend stage0, IR verificado, contratos, modelos reducidos y gobernanza; las otras 40 tareas están PENDIENTES. Core baja a IR verificado, pero no se ejecuta y no demuestra independencia de Rust. Ninguno de los 29 requisitos funcionales se ha aceptado por estos cierres. El registro incluye `esp_progress` para cierres ESP. No hay release nueva ni auditoría de seguridad completada.
