...
\caption{From declarative trust relationships to runtime artifacts and
semantic digests. Digest validity establishes content linkage only; it does not
validate the truth of a credential or policy assertion.}
\label{fig:evidence-chain}
\end{figure}

\Cref{fig:evidence-chain} therefore ends the implemented chain at local
artifact linkage; it does not extend the chain to an issuer, credential
authority, or remote agent.
